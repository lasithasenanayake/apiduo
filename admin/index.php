...
<head>
    ...
    <title>Dashboard One | yissum</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            <h2><span class="counter">100,000</span>k</h2>
                            <p>Data Bandwith out</p>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="footer-copy-right">
                        <p>Copyright © 2018 
. All rights reserved Duo Subscribe API Server.  powered by  <a href="http://yissum.davvag.com/">yissum</a>.</p>
                    </div>
                </div>
            </div>
        </div>
